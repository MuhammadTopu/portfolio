...
export function Navbar({ activePage, setActivePage }) {
    ...
    return (
        <nav className="fixed bottom-0 left-0 right-0 bg-card   border-foreground z-50 lg:static lg:border-t-0  lg:mb-8 lg:bg-transparent">
            <ul className="flex justify-center items-center lg:gap-10 px-1 lg:px-0">
                {navItems.map(item => {
