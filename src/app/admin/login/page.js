...
export default function AdminLoginPage() {
  ...
  return (
<div className="min-h-screen bg-background flex items-center justify-center px-4 shadow-[0_0_60px_rgba(255,255,255,0.2)]">      <div className="w-full max-w-md border-2 border-card-border sketch-border bg-card p-8">
